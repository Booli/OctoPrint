        ...
        self.getAdditionalControls = function() {
            return [
                { name: "Xeed", type: "section", children: [
                    ...
                    {name: "Level bed", commands: ["T0", "G32"], confirm: "Do you want to level the bed?"},
                    {name: "Quick load", commands: ["T0", "G28 X0 Y0", "G1 X270 Y10 F9000", "G91", "G1 E1900 F2000", "G1 E200 F100", "G90"], confirm: "Do you want to load filament to the active nozzle? Make sure the filament is loaded correctly in the bottom drawer and your nozzle is pre-heated. This action will home X and Y, move the head to the load position(right front) and load the filament."},
